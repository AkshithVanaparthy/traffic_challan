...
net = cv2.dnn.readNet('C:\\Users\\AKSHITH\Documents\\traffic challan\\plate\\darknet-yolov3.cfg', 'C:\\Users\\AKSHITH\Documents\\traffic challan\\plate\\lapi.weights')

    # Load COCO labels
with open("C:\\Users\\AKSHITH\Documents\\traffic challan\\plate\\classes.names", "r") as f:
...
def detect(frame):
    ...
    for i in indices:
        ...
        _, plate_number = cv2.threshold(plate_number, 150, 255, cv2.THRESH_BINARY + cv2.THRESH_OTSU)  # Apply threshold
