...
net = cv2.dnn.readNet('C:\\Users\\AKSHITH\\Documents\\traffic challan\\bike\\yolov3_pb.cfg',
                      'C:\\Users\\AKSHITH\\Documents\\traffic challan\\bike\\yolov3-obj_final.weights')

# Load COCO labels
with open('C:\\Users\\AKSHITH\\Documents\\traffic challan\\bike\\coco.names', "r") as f:
    classes = f.read().strip().split("\n")
def detect(frame,helmetviolated,tripleviolated):
    ...
    return frame,helmetviolated,tripleviolated
